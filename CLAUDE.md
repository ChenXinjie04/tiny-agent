...
本文件是这个项目的"说明书"，供每次 Claude Code 会话快速了解项目背景与约定。

## 项目目标

用 **TypeScript** 编写一个调用 **DeepSeek API** 的**终端交互式 coding agent**——类似 Claude Code 的命令行助手：能在终端中多轮对话，并通过工具调用读写文件、执行命令来帮助完成编码任务。
